...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        self.tableDict = [dict objectForKey:@"ResourceInfo"];
        
        self.columnData = [NSMutableArray arrayWithObjects:@"资源名称/编号", @"类型", @"面积",@"出租单价/总价",@"更新时间",@"状态",nil];
        
        self.tableView = [[EWMultiColumnTableView alloc] initWithFrame:CGRectMake(41, 434, 942, 232)];
