//
//  StaticsManagerViewController.h
//  IPM
//
...
@interface StaticsManagerViewController : RootViewController<EWMultiColumnTableViewDataSource,EWMultiColumnTableViewDelegate>
