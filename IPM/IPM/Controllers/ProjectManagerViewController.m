...
- (void)viewDidLoad
{
    ...
    NSString *dataFile = [[NSBundle mainBundle] pathForResource:@"ProjectManagerData" ofType:@"plist"];
...
{
    ProjectInfoViewController *controller = [[ProjectInfoViewController alloc] initWithNibName:@"ProjectInfoViewController" bundle:nil];
